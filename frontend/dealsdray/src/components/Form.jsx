...
const Form = () => {
    ...
    const createEmployee = async(data) => {
        try {
            let response = await axios.post("http://localhost:8088/api/create/employee",data);
        ...
        <form action="/your-server-side-script" method="post" encType="multipart/form-data" onSubmit={handleFormSubmission}>
            ...
            <div className="mb-4">
                ...
                <div className="flex items-center">
                    <input type="radio" id="male" onChange={handleInputChange}  name="f_Gender" value="Male" required className="mr-2" />
                    <label htmlFor="male" className="mr-4">Male</label>
                    <input type="radio" id="female" onChange={handleInputChange}  name="f_Gender" value="Female" required className="mr-2" />
            ...
            <div className="mb-4">
                ...
                <div className="flex flex-row gap-[15px]">
                    <label className="inline-flex items-center mt-2">
                        <input type="checkbox" onChange={handleInputChange} name="f_Course" value="MCA" className="mr-2" />
                        <span>MCA</span>
                    </label>
                    <label className="inline-flex items-center mt-2">
                        <input type="checkbox" onChange={handleInputChange} name="f_Course" value="BCA" className="mr-2" />
                        <span>BCA</span>
                    </label>
                    <label className="inline-flex items-center mt-2">
                        <input type="checkbox" onChange={handleInputChange} name="f_Course" value="BSC" className="mr-2" />
                        <span>BSC</span>
                    </label>
                </div>
            </div>
